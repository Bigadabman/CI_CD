...
В проекте создана простая веб-страница с формой заявки. Для неё написаны 4 UI-теста на Selenium в Firefox. GitHub Actions автоматически запускает тесты при изменениях и публикует сайт на GitHub Pages после успешной проверки ветки `main`.
